...
def test_depth4_ab_aa_sharing_uses_two_unitary_modules():
    runner = load_runner_module()
    architecture = runner.Architecture(
        name="p4-ab-aa-depth4",
        decision="Use A/B/A/A two-unitary sharing under repeated data encoding.",
        patch_size=4,
        patch_stride=4,
        layers=4,
        channels=16,
    ...
    assert set(variables["params"]) == {"ab_aa_a", "ab_aa_b"}
