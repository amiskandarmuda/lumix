...
def test_depth4_abc_a_sharing_uses_three_unitary_modules():
    runner = load_runner_module()
    architecture = runner.Architecture(
        name="p4-abc-a-depth4",
        decision="Use A/B/C/A three-unitary sharing under repeated data encoding.",
        patch_size=4,
        patch_stride=4,
        layers=4,
        channels=16,
    ...
    assert set(variables["params"]) == {"abc_a", "abc_b", "abc_c"}
