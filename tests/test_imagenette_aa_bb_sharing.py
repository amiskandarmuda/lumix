...
def test_depth4_aa_bb_sharing_uses_two_unitary_modules():
    runner = load_runner_module()
    architecture = runner.Architecture(
        name="p4-aa-bb-depth4",
        decision="Use A/A/B/B two-unitary sharing under repeated data encoding.",
        patch_size=4,
        patch_stride=4,
        layers=4,
        channels=16,
    ...
    assert set(variables["params"]) == {"aa_bb_a", "aa_bb_b"}
